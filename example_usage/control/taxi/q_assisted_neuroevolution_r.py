...
algorithm = QAssistedNeuroEvolution(env=env,policy_network_creator_fn=policy_creator_fn, write_summary=True, feature_constructor=feature_constructor, q_learner_num_steps=1000, q_learner_target_network_update_frequency=500, replay_buffer_minimum_size=1000, replay_buffer_capacity=5000)
